...
function et_password_form() {
	...
	$form_output = sprintf(
		'<div class="et_password_protected_form">
			<img src="https://168million.nl/wp-content/uploads/2023/09/2050-Paris-2050-Paris-logo.svg" width="125px" />
			<h1>%1$s</h1>
			<p style="margin-bottom:20px">%2$s</p>
			<form action="%3$s" method="post">
				<p><label for="%4$s" style="color:#000;font-weight:bold">Password </label><input name="post_password" id="%4$s" type="password" size="20" maxlength="20" /></p>
				<p><button type="submit" name="et_divi_submit_button" class="password-btn">%6$s</button></p>
			</form>
			<p style="text-align:center;padding-bottom:0px;margin-top:20px"><a href="https://2050.paris">Explore the 2050 Paris</a></p>
			<p style="text-align:center;padding-bottom:0px;"><a href="https://2050.paris/cookies-2/">Privacy & Terms.</a></p>
		</div>',
		esc_html__( 'Sign In', 'Divi' ),
		esc_html__( 'Log in to access your 2050 Paris sales performance metrics.', 'Divi' ),
		esc_url( site_url( 'wp-login.php?action=postpass', 'login_post' ) ),
		esc_attr( 'pwbox-' . $pwbox_id ),
		esc_html__( 'Password', 'Divi' ),
		esc_html__( 'Continue', 'Divi' )
	);
