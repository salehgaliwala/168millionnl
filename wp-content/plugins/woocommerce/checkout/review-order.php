...
if ($total != 25 && $total != 50 && $total != 100 && $total != 150)
    $is_other = true;
else
	$is_other = false;
...
if ($direct_donation) :?>
    ...
    <ul class="wc_payment_amounts">
        <li class="wc_payment_amount">
            <input <?php if ($total == 25) echo 'checked'; ?> id="payment_amount_25" type="radio" class="input-radio" name="payment_amount" value="10" >
            <label for="payment_amount_25">€ 25</label>
        </li>
        <li class="wc_payment_amount">
            <input <?php if ($total == 50) echo 'checked'; ?> id="payment_amount_50" type="radio" class="input-radio" name="payment_amount" value="25" >
            <label for="payment_amount_50">€ 50</label>
        </li>
        <li class="wc_payment_amount">
            <input <?php if ($total == 100) echo 'checked'; ?> id="payment_amount_100" type="radio" class="input-radio" name="payment_amount" value="50" >
            <label for="payment_amount_50">€ 100</label>
        </li>
        <li class="wc_payment_amount">
            <input <?php if ($total == 150) echo 'checked'; ?> id="payment_amount_150" type="radio" class="input-radio" name="payment_amount" value="100" >
            <label for="payment_amount_150">€ 150</label>
        </li>
        ...
        <div class="row align-items-center justify-content-center mb-5">
            <div class="col-md-5">
                ...
                <div class="input-group mb-2">
                    ...
                    <input id="payment_amount_other_value" class="form-control" type="number" name="payment_amount_other_value" value="<?php echo intval($total); ?>" >
                </div>
            </div>
        </div>
    </div>
